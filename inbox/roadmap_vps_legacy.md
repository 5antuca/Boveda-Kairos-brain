...
- [x] **Trebol v3 — Rediseño Completo** (2026-03-03): Workflow nuevo de 50 nodos (vs 131). Estado de conversación en Redis, clasificador contextual, 1 Code node reemplaza 6 Edit Fields, parseo JSON sin LLM Chain, loop de envío unificado, error handling en todas las rutas. Archivo: `workflows/trebol_v3_test.json`. Documentación: `.claude/context/newTREBOLarchitecture.md`.
