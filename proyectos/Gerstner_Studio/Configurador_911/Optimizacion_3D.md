...
## ⏩ HANDOFF / continuación
El plan de **fotorrealismo + el handoff** para Claude Code corriendo en la Mac se movió a su propio doc, que es el punto de entrada: **[[SPEC_Photoreal_Pipeline]]**. Este doc (`Optimizacion_3D`) queda como detalle histórico de la sesión de optimización + recetas `gltf-transform` + quirks de Max.
