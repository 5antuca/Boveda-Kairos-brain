...
| **F2** | Auto-schema "de fábrica" (Excel→canónico) + agente de onboarding | ⏳ siguiente — el diferenciador |
...
**F2 — auto-schema "de fábrica"**: mapeador determinístico Excel→canónico con score de confianza + agente de onboarding que pregunta solo lo ambiguo. Es el diferenciador del producto.
