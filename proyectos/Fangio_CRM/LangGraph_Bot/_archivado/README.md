...
motivo: rollback al bot del 18-abril como base de FangioBot
---
...
El 1-mayo-2026 se ejecutó un rollback del bot Trebol al estado del 18-abril (commit `7f1e5c2`) como base limpia para el agente de respuestas de FangioBot. El roadmap previo (Sales Swarm, principios canónicos, multi-LLM, optimizaciones de tokens) NO se aplica al agente actual — quedó obsoleto en ese mismo rollback.
